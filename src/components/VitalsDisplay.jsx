            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="glass-panel p-3 flex items-center justify-between min-h-[50px]">
                    <div className="flex items-center space-x-2 space-x-reverse min-w-0 flex-1">
                        ...
                        <span className="text-gray-400 text-[10px] font-medium leading-tight truncate">مخزون القلوكاجون</span>
                    </div>
                    <div className="flex items-baseline space-x-1 space-x-reverse flex-shrink-0 mr-2">
                        <span className="text-sm font-bold text-mueen-cyan leading-none">{typeof glucagonLevel === 'number' ? glucagonLevel.toFixed(1) : glucagonLevel}</span>
                        <span className="text-[8px] text-gray-500 font-bold uppercase leading-none">mg</span>
                    </div>
                </div>
